...
import XLMIMG from "../assets/xlm.png";
import LTCIMG from "../assets/ltc.png"; // need to fix this
        ...
        return (
            <>
                <div className="content">
                    {data[i].image === null ? "" 
                    : <img className="img" src={data[i].image} alt=""/>}
                    <div className="text">
                        <h3 className="title">{data[i].title}</h3>
                        {data[i].text}
                    </div>
                </div>
            </>)
